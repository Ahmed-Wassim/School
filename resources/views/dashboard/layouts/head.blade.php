    ...
    header start-->
        <nav class="admin-header navbar navbar-default col-lg-12 col-12 p-0 fixed-top d-flex flex-row">
            ...
            <div class="text-start navbar-brand-wrapper">
                <a class="navbar-brand brand-logo" href="index.html"><img src={{ asset('assets/images/logo-white.png') }}
                        alt="" /></a>
                <a class="navbar-brand brand-logo-mini" href="index.html"><img
                        src={{ asset('assets/images/logo-icon-light.png') }} alt="" /></a>
            </div>
            <!-- Top bar left -->
                ...
                <li class="nav-item dropdown">
                    ...
                    <div class="dropdown-menu dropdown-menu-right dropdown-big dropdown-notifications">
                        ...
                        <a href="#" class="dropdown-item">New registered user
                            <small class="float-end text-muted time">Just now</small>
                        </a>
                        <a href="#" class="dropdown-item">New invoice received
                            <small class="float-end text-muted time">22 mins</small>
                        </a>
                        <a href="#" class="dropdown-item">Server error report<small
                                class="float-end text-muted time">7 hrs</small>
                        </a>
                        <a href="#" class="dropdown-item">Database report<small
                                class="float-end text-muted time">1 days</small>
                        </a>
                        <a href="#" class="dropdown-item">Order confirmation<small
                                class="float-end text-muted time">2 days</small>
                        </a>
                    </div>
                </li>
                <li class="nav-item dropdown">
