...
<div class="side-menu-fixed">
    <div class="scrollbar side-menu-bg">
        <ul class="nav navbar-nav side-menu" id="sidebarnav">
            <!-- menu item Dashboard-->
            <li>
                <a href="{{ route('home') }}"><i class="ti-menu-alt"></i><span class="right-nav-text">
                        Dashboard</span>
                </a>
            </li>
            <!-- menu title -->
            <li class="mt-10 mb-10 text-muted ps-4 font-medium menu-title">
                School
            </li>
            <!-- menu item Elements-->
            <li>
                <a href="javascript:void(0);" data-bs-toggle="collapse" data-bs-target="#elements">
                    <div class="pull-left">
                        <i class="ti-palette"></i><span class="right-nav-text">Parent</span>
                    </div>
                ...
                <ul id="elements" class="collapse" data-bs-parent="#sidebarnav">
                    <li>
                        <a href="{{ route('parent.index') }}">Parents</a>
                    </li>
            ...
            <li>
                <a href="javascript:void(0);" data-bs-toggle="collapse" data-bs-target="#chart">
                    <div class="pull-left">
                        <i class="ti-pie-chart"></i><span class="right-nav-text">Charts</span>
                    </div>
                    <div class="pull-right">
                        <i class="ti-plus"></i>
                    </div>
                ...
                <ul id="chart" class="collapse" data-bs-parent="#sidebarnav">
                    ...
                    <li>
                        <a href="chart-morris.html">Chart morris
                        </a>
                    </li>
                    <li>
                        <a href="chart-sparkline.html">Chart Sparkline</a>
                    </li>
                </ul>
            </li>
            ...
            <li>
                <a href="javascript:void(0);" data-bs-toggle="collapse" data-bs-target="#font-icon">
                    <div class="pull-left">
                        <i class="ti-home"></i><span class="right-nav-text">font icon</span>
                    </div>
                    <div class="pull-right">
                        <i class="ti-plus"></i>
                    </div>
                ...
                <ul id="font-icon" class="collapse" data-bs-parent="#sidebarnav">
                    <li>
                        <a href="fontawesome-icon.html">font Awesome</a>
                    </li>
                    <li>
                        <a href="themify-icons.html">Themify icons</a>
                    </li>
                    <li>
                        <a href="weather-icon.html">Weather icons</a>
                    </li>
                </ul>
            </li>
            <!-- menu title -->
            ...
            <li>
                <a href="widgets.html"><i class="ti-blackboard"></i><span class="right-nav-text">Widgets</span>
                    <span class="badge bg-danger float-end mt-1">59</span>
                </a>
            </li>
            <!-- menu item Form-->
            <li>
                <a href="javascript:void(0);" data-bs-toggle="collapse" data-bs-target="#Form">
                    <div class="pull-left">
                        <i class="ti-files"></i><span class="right-nav-text">Form & Editor</span>
                    </div>
                    <div class="pull-right">
                        <i class="ti-plus"></i>
                    </div>
                ...
                <ul id="Form" class="collapse" data-bs-parent="#sidebarnav">
                    ...
                    <li>
                        <a href="editor-markdown.html">Editor Markdown</a>
                    </li>
                    <li>
                        <a href="form-input.html">Form input</a>
                    </li>
                    <li>
                        <a href="form-validation-jquery.html">form validation jquery</a>
                    </li>
                    <li>
            ...
            <li>
                <a href="javascript:void(0);" data-bs-toggle="collapse" data-bs-target="#table">
                    <div class="pull-left">
                        <i class="ti-layout-tab-window"></i><span class="right-nav-text">data table</span>
                    </div>
                    <div class="pull-right">
                        <i class="ti-plus"></i>
                    </div>
                ...
                <ul id="table" class="collapse" data-bs-parent="#sidebarnav">
                    <li>
                        <a href="data-html-table.html">Data html table</a>
                    </li>
                    <li>
                        <a href="data-local.html">Data local</a>
                    </li>
                    <li>
            ...
            <li>
                <a href="javascript:void(0);" data-bs-toggle="collapse" data-bs-target="#custom-page">
                    <div class="pull-left">
                        <i class="ti-file"></i><span class="right-nav-text">Custom pages</span>
                    </div>
                    <div class="pull-right">
                        <i class="ti-plus"></i>
                    </div>
                ...
                <ul id="custom-page" class="collapse" data-bs-parent="#sidebarnav">
                    ...
                    <li>
                        <a href="project-summary.html">Projects summary</a>
                    </li>
                    <li><a href="profile.html">profile</a></li>
                    <li>
                        <a href="app-contacts.html">App contacts</a>
                    </li>
                    <li>
                    ...
                    <li>
                        <a href="layout-container.html">layout container</a>
                    </li>
            ...
            <li>
                <a href="javascript:void(0);" data-bs-toggle="collapse" data-bs-target="#authentication">
                    <div class="pull-left">
                        <i class="ti-id-badge"></i><span class="right-nav-text">Authentication</span>
                    </div>
                    <div class="pull-right">
                        <i class="ti-plus"></i>
                    </div>
            ...
            <li>
                <a href="maps.html"><i class="ti-location-pin"></i><span class="right-nav-text">maps</span>
                    <span class="badge bg-success float-end mt-1">06</span></a>
            </li>
            <!-- menu item timeline-->
            <li>
            ...
            <li>
                <a href="javascript:void(0);" data-bs-toggle="collapse" data-bs-target="#multi-level">
                    <div class="pull-left">
                        <i class="ti-layers"></i><span class="right-nav-text">Multi level Menu</span>
                    </div>
                    <div class="pull-right">
                        <i class="ti-plus"></i>
                    </div>
                ...
                <ul id="multi-level" class="collapse" data-bs-parent="#sidebarnav">
                    <li>
                        <a href="javascript:void(0);" data-bs-toggle="collapse" data-bs-target="#auth">Level item 1
                            <div class="pull-right">
                                <i class="ti-plus"></i>
                            </div>
                            <div class="clearfix"></div>
                        ...
                        <ul id="auth" class="collapse">
                            <li>
                                <a href="javascript:void(0);" data-bs-toggle="collapse" data-bs-target="#login">Level
                                    item 1.1
                                    <div class="pull-right">
                                        <i class="ti-plus"></i>
                                    </div>
                                ...
                                <ul id="login" class="collapse">
                                    <li>
                                        <a href="javascript:void(0);" data-bs-toggle="collapse"
                                            data-bs-target="#invoice">level item 1.1.1
                                            <div class="pull-right">
                                                <i class="ti-plus"></i>
                                            </div>
                                            <div class="clearfix"></div>
                            ...
                            <li>
                                <a href="#">level item 1.2</a>
                            </li>
                        </ul>
                    </li>
                    <li>
                        <a href="javascript:void(0);" data-bs-toggle="collapse" data-bs-target="#error">level item 2
                            <div class="pull-right">
                                <i class="ti-plus"></i>
                            </div>
                            <div class="clearfix"></div>
                        ...
                        <ul id="error" class="collapse">
                            <li>
                                <a href="#">level item 2.1</a>
                            </li>
                            <li>
                                <a href="#">level item 2.2</a>
                            </li>
                        </ul>
                    </li>
                </ul>
